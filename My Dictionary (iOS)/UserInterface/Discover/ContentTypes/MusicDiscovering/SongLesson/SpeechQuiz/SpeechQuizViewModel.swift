...
extension SongLesson {
    ...
    final class SpeechQuizViewModel: ObservableObject {
        ...
        func startRecording() async {
            ...
            logInfo("[SpeechQuizViewModel] Starting to record")
        ...
        func stopRecording() async {
            ...
            logInfo("[SpeechQuizViewModel] Stopped recording. Snapshot: \(spokenSnapshot)")
        ...
        private func completeCurrentAttempt(spokenText: String) async {
            ...
            logInfo("[SpeechQuizViewModel] Completing attempt with spoken text: \(cleanedSpoken)")
        ...
        private func evaluate(spokenText: String) -> Bool {
            logInfo("[SpeechQuizViewModel] Evaluating: \(spokenText)")
        ...
        private func deactivateAudioSession() {
            ...
            do {
                ...
                logWarning("Failed to deactivate audio session: \(error.localizedDescription)")
            }
        }
    }
}
