...
final class ChooseDefinitionQuizViewModel: BaseViewModel {
    ...
    private func getNextQuestion() {
        ...
        // Add 2 more words as incorrect options with same part of speech to prevent cheating
        ...
        if samePartOfSpeechItems.count >= 2 {
            ...
            // Use the one same POS word + one random word
            ...
            // Fallback: use any remaining words (same as before)
