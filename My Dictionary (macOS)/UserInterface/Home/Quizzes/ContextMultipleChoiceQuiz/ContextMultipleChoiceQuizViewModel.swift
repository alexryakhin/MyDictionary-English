    ...
    private func prefetchQuestionForItem(_ item: any Quizable) {
        prefetchTask = Task {
            do {
                ...
                let question = try await aiService.generateSingleContextQuestion(word: word, wordLanguage: wordLanguage)
    ...
    private func generateFirstContextQuestion() {
        ...
        Task {
            do {
                ...
                let contextQuestion = try await aiService.generateSingleContextQuestion(word: firstWord, wordLanguage: wordLanguage)
    ...
    private func prefetchNextQuestion() {
        ...
        prefetchTask = Task {
            do {
                ...
                let contextQuestion = try await aiService.generateSingleContextQuestion(word: nextWord, wordLanguage: wordLanguage)
