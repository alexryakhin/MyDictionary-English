# My Dictionary - Collaborative Vocabulary Learning Platform
...
- **Song lessons**: Listen to your favorite songs and take personalized lessons
- **StoryLab**: Create 1-4 page stories using your own words or a custom theme, and take comprehension quiz
...
- **Quiz results history**: Monitor accuracy, practice time, and session statistics
...
- **App Store**: [My Dictionary: Learn Languages](https://apps.apple.com/app/1588418793)
...
- English, Spanish, French, German, Croatian, Russian, Ukrainian, Chinese, Hindi and more. 55 in total
